module.exports = async ({ client, imageGenerators, util, Discord, loadingImage, simulatedChannel, _ }, message) => {
    ...
    m.edit(embed.setImage(await imageGenerators.gathering(_, message.author, location, { name: "Chopping", ...player.chopping }, result.added.concat(result.dropped), xpGain)));
