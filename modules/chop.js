module.exports = async ({ client, imageGenerators, util, Discord, loadingImage, simulatedChannel, _ }, message) => {
    ...
    else image = imageGenerators.gathering(_, message.author, location, player.explore.area.name, "Chopping", { amount: player.explore.area.durability, maxAmount: area.durability }, damage);
