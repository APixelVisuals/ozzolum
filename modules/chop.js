module.exports = async ({ client, imageGenerators, util, Discord, loadingImage, simulatedChannel, _ }, message) => {
    ...
    else image = imageGenerators.gathering(_, message.author, location.name, player.explore.area.name, "Chopping", { amount: player.explore.area.durability, maxAmount: area.durability }, damage);
